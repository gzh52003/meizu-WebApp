<template>
	<div class="goods">
        ...
        ">
			<van-image height="235" width="235" :src="gooddata.img" fit="fill"></van-image>
		...
		<div class="gooddescript">
			...
			<van-action-sheet v-model="showserver" title="服务说明" style="padding:0">
				<div class="window-content">
					...
					<div>
						<h5>
							<svg t="1599287592529" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
							 p-id="576" width="18" height="18">
								<path d="M511.486812 66.465784c-245.00611 0-443.623703 198.634989-443.623703 443.641099 0 245.021459 198.617593 443.623703 443.623703 443.623703s443.623703-198.60122 443.623703-443.623703C955.109492 265.100774 756.492922 66.465784 511.486812 66.465784M511.486812 909.068388c-220.337267 0-398.962527-178.62526-398.962527-398.962527 0-220.354664 178.62526-398.980947 398.962527-398.980947 220.337267 0 398.962527 178.626283 398.962527 398.980947C910.449339 730.444151 731.824079 909.068388 511.486812 909.068388"
								 p-id="577" fill="#30B4FF"></path>
								<path d="M771.216251 349.083513c-111.791086-50.715055-224.594221 0-224.594221 0l0 363.268584 64.165392 0L610.787422 413.265278c64.163345-42.427298 160.428829 0 160.428829 0L771.216251 349.083513z"
								 p-id="578" fill="#30B4FF"></path>
								<path d="M674.986583 484.845547c-6.332219 6.559393-9.857509 15.717983-9.507538 24.860201l67.949578 0c0.330528-9.142218-3.176342-18.300808-9.525957-24.860201-6.315846-6.54302-15.352663-10.397814-24.457018-10.397814C690.339246 474.447732 681.301406 478.302527 674.986583 484.845547"
								 p-id="579" fill="#30B4FF"></path>
								<path d="M268.198833 603.685165l0 72.451102c64.689325 54.326303 233.919611 42.951231 233.919611-75.555813 0-116.415406-169.230286-127.300314-169.230286-184.209442 0-34.157961 65.725934-61.617359 146.446373-9.333576L479.334531 344.949356c-30.267351-30.268374-218.383776-53.819766-218.383776 72.451102 0 121.089869 174.927031 115.402333 174.927031 178.01537C435.877787 664.7438 336.002079 666.296155 268.198833 603.685165"
								 p-id="580" fill="#30B4FF"></path>
							</svg>
							顺丰发货
						</h5>
						<p>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getData(id,iq) {
					if(iq==0){
						const {data} = await this.$request.get("/cart/list/" + id);
